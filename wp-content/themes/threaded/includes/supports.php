...
if ( ! function_exists( 'threaded_add_theme_supports' ) ) {
	/**
	 ...
	 * @return void
	 */
	function threaded_add_theme_supports() {
		/**
...
add_action( 'after_setup_theme', 'threaded_add_theme_supports' );

if ( ! function_exists( 'threaded_load_textdomain' ) ) {
	/**
	 ...
	 * @return void
	 */
	function threaded_load_textdomain() {
		load_theme_textdomain( 'threaded-wp-starter-theme', get_template_directory() . '/languages' );
	}
}
add_action( 'after_setup_theme', 'threaded_load_textdomain' );
